...
Plug 'Raimondi/delimitMate'                            " automatically add closing parens and stuff
Plug 'vim-airline/vim-airline'                         " lean and mean status/tabline
Plug 'vim-airline/vim-airline-themes'                  " themes for airline
Plug 'tpope/vim-commentary'                            " toggle comments, syntax aware
Plug 'tpope/vim-endwise'                               " auto add end words in Ruby
...
Plug 'mileszs/ack.vim'                                 " Finding things
Plug 'morhetz/gruvbox'                                 " Preferred color scheme
